...
class TTXs(ROIs):
    ...
    def __init__(self, expmeta, loglevel='info'):
        ...
        tmp_data_path = glob.glob('{}.pickle'.format('../output/save_data_ttx/{}'.format(self.expdate + '_' + self.expnum)))
    ...
    def save_csv(self):
        ...
        output.to_csv('../output/csv_ttx/{}_{}.csv'.format(self.expdate, self.expnum), ',')
        ...
        for lev in np.arange(60, 75, 5):
            ...
            output.to_csv('../output/csv_ttx/{}_{}_pairs_{}.csv'.format(self.expdate, self.expnum, lev), ',')
    ...
    def save_pickle(self, save_df_sta=True, save_df_pairs=True, save_df_cntr=True):
        ...
        with open('../output/save_data_ttx/{}.pickle'.format(self.expdate + '_' + self.expnum), 'wb') as f:
            pickle.dump(d, f)     
# class TTXs(ROIs):
